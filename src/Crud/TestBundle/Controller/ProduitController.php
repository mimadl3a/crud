...
use Crud\TestBundle\Entity\Produit;
use Crud\TestBundle\Form\ProduitType;
...
class ProduitController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CrudTestBundle:Produit')->findAll();

        return $this->render('CrudTestBundle:Produit:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('CrudTestBundle:Produit:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CrudTestBundle:Produit')->find($id);
        ...
        return $this->render('CrudTestBundle:Produit:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('CrudTestBundle:Produit:edit.html.twig', array(
            'entity'      => $entity,
